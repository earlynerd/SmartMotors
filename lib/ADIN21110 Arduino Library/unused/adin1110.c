...
adi_eth_Result_e adin1110_Init(adin1110_DeviceHandle_t hDevice, adin1110_DriverConfig_t *pCfg)
{
    ...
    {  
        DEBUG_MESSAGE("device memory invalid pCfg->devMemSize %d, ADIN1110_DEVICE_SIZE %d", pCfg->devMemSize, ADIN1110_DEVICE_SIZE);
    ...
    {
        // DEBUG_MESSAGE("macDriverEntry.Init Success\r\n");
        ...
        if (result == ADI_ETH_SUCCESS)
        {
            // DEBUG_MESSAGE("phyDriverEntry.Init Success\r\n");
        }
        else
        {
            // DEBUG_MESSAGE("phyDriverEntry.Init fail\r\n");
        }
    ...
    {
        // DEBUG_MESSAGE("macDriverEntry.Init failed\r\n");
    }

end:
    // DEBUG_MESSAGE("returnings %d\r\n", result);
    return result;
}

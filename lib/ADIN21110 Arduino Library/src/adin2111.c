...
adi_eth_Result_e adin2111_SetUserContext(adin2111_DeviceHandle_t hDevice, void *pContext)
{
    adi_eth_Result_e    result = ADI_ETH_SUCCESS;
    ...
    if ((hDevice->pPhyDevice == NULL) || (hDevice->pPhyDevice[0]->state == ADI_PHY_STATE_UNINITIALIZED) || (hDevice->pPhyDevice[1]->state == ADI_PHY_STATE_UNINITIALIZED) ||
 ...
 */
void *adin2111_GetUserContext(adin2111_DeviceHandle_t hDevice)
{
    void    *result = NULL;
